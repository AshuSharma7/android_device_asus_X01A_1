...
# Lights
PRODUCT_PACKAGES += \
    android.hardware.light@2.0-service.basic
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/android.software.device_id_attestation.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.software.device_id_attestation.xml \
